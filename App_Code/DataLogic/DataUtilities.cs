...
namespace DataManager
{
   public class DataUtilities
   {
        ...
        public string GetConnectionString()
        {
           ...
           return "Data Source=209.222.108.170;Initial Catalog=SerendipityWebsiteDB;User ID=serenwebsite;Password=Dino@321;";
	        //return "Data Source=A8CRM01;Database=a8cm_db;User Id=itadmin;Password=3edc4rFVCvDfEr#4;";
            //return "Data Source=DINH0013-TEJA\\SQLEXPRESS;Database=crm_qa_db_test1;integrated security=true";
        }
        ...
        public DataSet ExecuteDataSet(string commandText, string parameter1)
        {
            var dsData = new DataSet();
            var objMyDataAdapter = new SqlDataAdapter();
            SqlConnection objMySqlConn = GetSqlConnection();
